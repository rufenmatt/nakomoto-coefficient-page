...
},{"./adapters/http":4,"./adapters/xhr":4,"./core/enhanceError":14,"./helpers/normalizeHeaderName":26,"./utils":30,"_process":2}],19:[function(require,module,exports){
'use strict';
...
var Chain = /** @class */ (function () {
    function Chain(name, coingeckoId, symbol, threshold) {
        this.name = name;
...
var cosmos = new chain_1.Chain("cosmoshub", "cosmos", "ATOM", 1 / 3);
cosmos["compute"] = function () {
    return __awaiter(this, void 0, void 0, function () {
        var price, validators, bonds, _a, totalBond, cummBond, coeff, bribe;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, axios_1["default"].get("https://api.coingecko.com/api/v3/simple/price?ids=".concat(this.coingeckoId, "&vs_currencies=usd"))];
                case 1:
                    price = (_b.sent()).data[this.coingeckoId].usd;
                    return [4 /*yield*/, axios_1["default"].get("https://cors-anywhere.herokuapp.com/https://api.cosmos.network/validatorsets/latest")];
                case 2:
                    validators = (_b.sent()).data.result.validators;
                    bonds = validators.map(function (validator) {
                        return (0, helpers_1.parseBigInt)(validator.voting_power, 0); // 1 voting power = 1 ATOM
                    });
...
},{"./chain":33,"./helpers":35,"axios":3}],35:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
},{"bn.js":32}],36:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var helpers_1 = require("./helpers");
var chains = [cosmos_1["default"], solana_1["default"], terra_1["default"], thorchain_1["default"]];
var promises = chains.map(function (chain) { return chain.compute(); });
function run() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            Promise.all(promises).then(function (results) {
                ...
                var rows = results.map(function (result) {
                    var row = "<tr>";
                    row += "<td>".concat(result.name, "</td>");
                    row += "<td>".concat(result.symbol, "</td>");
                    row += "<td>".concat((0, helpers_1.formatMoney)(result.price), "</td>");
                    // row += `<td>${formatInteger(result.totalBond)} ${result.symbol}</td>`;
                    row += "<td>".concat((0, helpers_1.formatPercentage)(result.threshold), "</td>");
                    row += "<td>".concat(result.coeff, "</td>");
                    row += "<td>".concat((0, helpers_1.formatMoney)(result.bribe, 0), "</td>");
                    row += "</tr>";
                    return row;
                });
...
},{"./cosmos":34,"./helpers":35,"./solana":37,"./terra":38,"./thorchain":39}],37:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var helpers_1 = require("./helpers");
var chain_1 = require("./chain");
var solana = new chain_1.Chain("solana", "solana", "SOL", 1 / 3);
solana["compute"] = function () {
    return __awaiter(this, void 0, void 0, function () {
        var price, validators, bonds, _a, totalBond, cummBond, coeff, bribe;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    price = (_b.sent()).data[this.coingeckoId].usd;
                    return [4 /*yield*/, axios_1["default"].post("https://solana-api.projectserum.com", {
                            jsonrpc: "2.0",
                            id: 1,
                            method: "getVoteAccounts"
                        })];
                case 2:
                    validators = (_b.sent()).data.result.current;
                    bonds = validators.map(function (validator) {
                        return (0, helpers_1.parseBigInt)(validator.activatedStake.toFixed(0), 9); // SOL has 9 decimal places
                    });
                    _a = (0, helpers_1.findCoeff)(bonds, this.threshold), totalBond = _a.totalBond, cummBond = _a.cummBond, coeff = _a.coeff;
                    bribe = cummBond * price;
                    console.log(this.name);
                    console.log("totalBond = ".concat((0, helpers_1.formatInteger)(totalBond), " ").concat(this.symbol));
                    console.log("coeff = ".concat(coeff));
...
},{"./chain":33,"./helpers":35,"axios":3}],38:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./chain":33,"./helpers":35,"axios":3}],39:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var helpers_1 = require("./helpers");
var chain_1 = require("./chain");
var thorchain = new chain_1.Chain("thorchain", "thorchain", "RUNE", 1 / 3);
thorchain["compute"] = function () {
    return __awaiter(this, void 0, void 0, function () {
        var price, nodes, activeNodes, bonds, _a, totalBond, cummBond, coeff, bribe;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, axios_1["default"].get("https://api.coingecko.com/api/v3/simple/price?ids=thorchain&vs_currencies=usd")];
                case 1:
                    price = (_b.sent()).data[this.coingeckoId].usd;
                    return [4 /*yield*/, axios_1["default"].get("https://midgard.thorchain.info/v2/thorchain/nodes")];
                case 2:
                    nodes = (_b.sent()).data;
                    activeNodes = nodes.filter(function (node) {
                        return node.status === "Active";
                    });
                    bonds = activeNodes.map(function (node) {
                        return (0, helpers_1.parseBigInt)(node.bond, 8); // RUNE has 8 decimal places
                    });
                    _a = (0, helpers_1.findCoeff)(bonds, 1 / 3), totalBond = _a.totalBond, cummBond = _a.cummBond, coeff = _a.coeff;
                    bribe = cummBond * price;
                    console.log(this.name);
...
},{"./chain":33,"./helpers":35,"axios":3}]},{},[36]);
